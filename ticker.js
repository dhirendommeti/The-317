...
const STOCK_TICKERS = [
  { sym: 'LLY',  name: 'Eli Lilly',             price: '1,264.64', pct: '-1.23%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'CMI',  name: 'Cummins',               price: '603.53',   pct: '-0.80%', up: false,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'ELV',  name: 'Elevance Health',       price: '398.15',   pct: '-0.08%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'STLD', name: 'Steel Dynamics',        price: '221.15',   pct: '-4.27%', up: false,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'SPG',  name: 'Simon Property Group',  price: '221.49',   pct: '-0.76%', up: false,  sector: 'Real Estate', state: 'Indiana'   },
  { sym: 'CTVA', name: 'Corteva',               price: '80.85',    pct: '+2.90%', up: true,  sector: 'Agriculture', state: 'Indiana'   },
  { sym: 'ALSN', name: 'Allison Transmission',  price: '126.37',   pct: '+1.24%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'CAT',  name: 'Caterpillar',           price: '813.83', pct: '-0.28%', up: false,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'DE',   name: 'Deere & Company',       price: '608.12',   pct: '+4.73%', up: true,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'ADM',  name: 'Archer-Daniels-Midland',price: '82.84',    pct: '+2.58%', up: true,  sector: 'Agriculture', state: 'Illinois'  },
  { sym: 'FITB', name: 'Fifth Third Bancorp',   price: '54.72',    pct: '-0.44%', up: false,  sector: 'Banking',     state: 'Ohio'      },
  { sym: 'PG',   name: 'Procter & Gamble',      price: '143.92',   pct: '-0.32%', up: false, sector: 'Consumer',    state: 'Ohio'      },
  { sym: 'WHR',  name: 'Whirlpool',             price: '39.18',    pct: '-2.27%', up: false, sector: 'Consumer',    state: 'Michigan'  },
  { sym: 'SYK',  name: 'Stryker',               price: '339.93',   pct: '-0.01%', up: false, sector: 'Healthcare',  state: 'Michigan'  },
  { sym: 'MMM',  name: '3M',                    price: '180.90',   pct: '+0.13%', up: true,  sector: 'Industrials', state: 'Minnesota' },
  { sym: 'TGT',  name: 'Target',                price: '159.54',   pct: '+0.34%', up: true, sector: 'Retail',      state: 'Minnesota' },
  { sym: 'USB',  name: 'U.S. Bancorp',          price: '62.61',    pct: '-0.33%', up: false,  sector: 'Banking',     state: 'Minnesota' },
  { sym: 'NTRS', name: 'Northern Trust',        price: '186.08',   pct: '+0.37%', up: true,  sector: 'Banking',     state: 'Illinois'  },
  { sym: 'CAH',  name: 'Cardinal Health',       price: '231.83',   pct: '-1.29%', up: false,  sector: 'Healthcare',  state: 'Ohio'      },
  { sym: 'BAX',  name: 'Baxter International',  price: '26.63',    pct: '-0.04%', up: false,  sector: 'Healthcare',  state: 'Illinois'  },
  { sym: 'MDT',  name: 'Medtronic',             price: '94.25',    pct: '+0.13%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'UNH',  name: 'UnitedHealth Group',    price: '390.17',   pct: '+0.40%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'PH',   name: 'Parker Hannifin',       price: '1,020.04',   pct: '-0.31%', up: false, sector: 'Industrials', state: 'Ohio'      },
  { sym: 'ITW',  name: 'Illinois Tool Works',   price: '284.27',   pct: '+0.01%', up: true, sector: 'Industrials', state: 'Illinois'  },
  { sym: 'EMR',  name: 'Emerson Electric',      price: '155.49',   pct: '-1.34%', up: false, sector: 'Industrials', state: 'Missouri'  },
  { sym: 'ROK',  name: 'Rockwell Automation',   price: '434.59',   pct: '+0.30%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'ABT', name: 'Abbott Laboratories', price: '115.15', pct: '+0.63%', up: true, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'ABBV', name: 'AbbVie', price: '265.72', pct: '-0.09%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'MCD', name: 'McDonald\'s', price: '270.27', pct: '+1.05%', up: true, sector: 'Consumer', state: 'Illinois' },
  { sym: 'EXC', name: 'Exelon', price: '45.67', pct: '+0.82%', up: true, sector: 'Energy', state: 'Illinois' },
  { sym: 'CAG', name: 'Conagra Brands', price: '16.09', pct: '-0.80%', up: false, sector: 'Agriculture', state: 'Illinois' },
  { sym: 'ALL', name: 'Allstate', price: '256.82', pct: '-1.12%', up: false, sector: 'Insurance', state: 'Illinois' },
  { sym: 'CME', name: 'CME Group', price: '269.77', pct: '+1.06%', up: true, sector: 'Banking', state: 'Illinois' },
  { sym: 'GWW', name: 'W.W. Grainger', price: '1,302.57', pct: '-0.34%', up: false, sector: 'Industrials', state: 'Illinois' },
  { sym: 'MPC', name: 'Marathon Petroleum', price: '367.03', pct: '+1.74%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'SHW', name: 'Sherwin-Williams', price: '344.58', pct: '-2.55%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'GT', name: 'Goodyear Tire & Rubber', price: '5.86', pct: '-2.17%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'PGR', name: 'Progressive Corporation', price: '221.15', pct: '+1.79%', up: true, sector: 'Insurance', state: 'Ohio' },
  { sym: 'AEP', name: 'American Electric Power', price: '127.19', pct: '+0.73%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'OC', name: 'Owens Corning', price: '146.38', pct: '-3.21%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'KR', name: 'Kroger', price: '55.59', pct: '-1.21%', up: false, sector: 'Retail', state: 'Ohio' },
  { sym: 'CLF', name: 'Cleveland-Cliffs', price: '10.56', pct: '-5.46%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'F', name: 'Ford Motor Company', price: '13.95', pct: '-3.79%', up: false, sector: 'Consumer', state: 'Michigan' },
  { sym: 'GM', name: 'General Motors', price: '83.85', pct: '-1.31%', up: false, sector: 'Consumer', state: 'Michigan' },
  { sym: 'DOW', name: 'Dow Inc', price: '32.93', pct: '+3.72%', up: true, sector: 'Industrials', state: 'Michigan' },
  { sym: 'GIS', name: 'General Mills', price: '39.63', pct: '-0.90%', up: false, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'BBY', name: 'Best Buy', price: '87.20', pct: '-2.25%', up: false, sector: 'Retail', state: 'Minnesota' },
  { sym: 'ECL', name: 'Ecolab', price: '284.55', pct: '-0.37%', up: false, sector: 'Industrials', state: 'Minnesota' },
  { sym: 'HRL', name: 'Hormel Foods', price: '24.18', pct: '-0.94%', up: false, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'HOG', name: 'Harley-Davidson', price: '27.37', pct: '-1.05%', up: false, sector: 'Consumer', state: 'Wisconsin' },
  { sym: 'JCI', name: 'Johnson Controls', price: '145.14', pct: '+0.14%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'GNRC', name: 'Generac Holdings', price: '207.04', pct: '-1.79%', up: false, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'CNC', name: 'Centene Corporation', price: '64.29', pct: '-0.63%', up: false, sector: 'Healthcare', state: 'Missouri' },
  { sym: 'HRB', name: 'H&R Block', price: '52.96', pct: '+1.36%', up: true, sector: 'Professional Services', state: 'Missouri' },
  { sym: 'BG', name: 'Bunge Global', price: '117.58', pct: '+3.14%', up: true, sector: 'Agriculture', state: 'Missouri' },
  { sym: 'PFG', name: 'Principal Financial Group', price: '111.30', pct: '-0.30%', up: false, sector: 'Insurance', state: 'Iowa' },
  { sym: 'CASY', name: 'Casey\'s General Stores', price: '836.27', pct: '+0.01%', up: true, sector: 'Retail', state: 'Iowa' },
  { sym: 'GRMN', name: 'Garmin', price: '295.57', pct: '-0.03%', up: false, sector: 'Technology', state: 'Kansas' },
  { sym: 'BRK-B', name: 'Berkshire Hathaway', price: '497.99', pct: '-0.33%', up: false, sector: 'Insurance', state: 'Nebraska' },
  { sym: 'UNP', name: 'Union Pacific', price: '303.03', pct: '+0.41%', up: true, sector: 'Industrials', state: 'Nebraska' },
  { sym: 'HUM', name: 'Humana', price: '383.62', pct: '+1.48%', up: true, sector: 'Healthcare', state: 'Kentucky' },
  { sym: 'YUM', name: 'Yum! Brands', price: '145.92', pct: '-0.01%', up: false, sector: 'Consumer', state: 'Kentucky' },
  { sym: 'BF-B', name: 'Brown-Forman', price: '28.09', pct: '-1.20%', up: false, sector: 'Consumer', state: 'Kentucky' },
];
