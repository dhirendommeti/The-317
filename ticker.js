...
const STOCK_TICKERS = [
  { sym: 'LLY',  name: 'Eli Lilly',             price: '1,180.46', pct: '-2.36%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'CMI',  name: 'Cummins',               price: '635.92',   pct: '+0.68%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'ELV',  name: 'Elevance Health',       price: '398.25',   pct: '+0.01%', up: true,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'STLD', name: 'Steel Dynamics',        price: '261.06',   pct: '+0.20%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'SPG',  name: 'Simon Property Group',  price: '220.42',   pct: '-0.47%', up: false,  sector: 'Real Estate', state: 'Indiana'   },
  { sym: 'CTVA', name: 'Corteva',               price: '76.59',    pct: '+1.06%', up: true,  sector: 'Agriculture', state: 'Indiana'   },
  { sym: 'ALSN', name: 'Allison Transmission',  price: '125.31',   pct: '+1.94%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'CAT',  name: 'Caterpillar',           price: '865.10', pct: '+1.23%', up: true,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'DE',   name: 'Deere & Company',       price: '611.14',   pct: '-0.20%', up: false,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'ADM',  name: 'Archer-Daniels-Midland',price: '80.69',    pct: '+0.67%', up: true,  sector: 'Agriculture', state: 'Illinois'  },
  { sym: 'FITB', name: 'Fifth Third Bancorp',   price: '58.34',    pct: '+0.69%', up: true,  sector: 'Banking',     state: 'Ohio'      },
  { sym: 'PG',   name: 'Procter & Gamble',      price: '143.89',   pct: '-0.26%', up: false, sector: 'Consumer',    state: 'Ohio'      },
  { sym: 'WHR',  name: 'Whirlpool',             price: '42.21',    pct: '-1.49%', up: false, sector: 'Consumer',    state: 'Michigan'  },
  { sym: 'SYK',  name: 'Stryker',               price: '337.72',   pct: '-0.99%', up: false, sector: 'Healthcare',  state: 'Michigan'  },
  { sym: 'MMM',  name: '3M',                    price: '182.97',   pct: '+0.18%', up: true,  sector: 'Industrials', state: 'Minnesota' },
  { sym: 'TGT',  name: 'Target',                price: '155.62',   pct: '+0.07%', up: true, sector: 'Retail',      state: 'Minnesota' },
  { sym: 'USB',  name: 'U.S. Bancorp',          price: '65.35',    pct: '+0.28%', up: true,  sector: 'Banking',     state: 'Minnesota' },
  { sym: 'NTRS', name: 'Northern Trust',        price: '190.51',   pct: '+0.02%', up: true,  sector: 'Banking',     state: 'Illinois'  },
  { sym: 'CAH',  name: 'Cardinal Health',       price: '232.48',   pct: '+0.54%', up: true,  sector: 'Healthcare',  state: 'Ohio'      },
  { sym: 'BAX',  name: 'Baxter International',  price: '26.85',    pct: '-0.74%', up: false,  sector: 'Healthcare',  state: 'Illinois'  },
  { sym: 'MDT',  name: 'Medtronic',             price: '91.22',    pct: '+0.71%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'UNH',  name: 'UnitedHealth Group',    price: '400.81',   pct: '+0.44%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'PH',   name: 'Parker Hannifin',       price: '1,054.45',   pct: '-0.42%', up: false, sector: 'Industrials', state: 'Ohio'      },
  { sym: 'ITW',  name: 'Illinois Tool Works',   price: '289.67',   pct: '-0.45%', up: false, sector: 'Industrials', state: 'Illinois'  },
  { sym: 'EMR',  name: 'Emerson Electric',      price: '164.23',   pct: '+0.01%', up: true, sector: 'Industrials', state: 'Missouri'  },
  { sym: 'ROK',  name: 'Rockwell Automation',   price: '449.56',   pct: '+0.91%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'ABT', name: 'Abbott Laboratories', price: '111.57', pct: '+0.27%', up: true, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'ABBV', name: 'AbbVie', price: '248.74', pct: '-0.83%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'MCD', name: 'McDonald\'s', price: '274.87', pct: '+0.96%', up: true, sector: 'Consumer', state: 'Illinois' },
  { sym: 'EXC', name: 'Exelon', price: '45.65', pct: '+0.11%', up: true, sector: 'Energy', state: 'Illinois' },
  { sym: 'CAG', name: 'Conagra Brands', price: '15.52', pct: '+0.84%', up: true, sector: 'Agriculture', state: 'Illinois' },
  { sym: 'ALL', name: 'Allstate', price: '259.74', pct: '-0.28%', up: false, sector: 'Insurance', state: 'Illinois' },
  { sym: 'CME', name: 'CME Group', price: '267.37', pct: '+0.06%', up: true, sector: 'Banking', state: 'Illinois' },
  { sym: 'GWW', name: 'W.W. Grainger', price: '1,321.22', pct: '-0.01%', up: false, sector: 'Industrials', state: 'Illinois' },
  { sym: 'MPC', name: 'Marathon Petroleum', price: '358.80', pct: '+0.68%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'SHW', name: 'Sherwin-Williams', price: '358.02', pct: '-0.98%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'GT', name: 'Goodyear Tire & Rubber', price: '6.20', pct: '+0.32%', up: true, sector: 'Industrials', state: 'Ohio' },
  { sym: 'PGR', name: 'Progressive Corporation', price: '208.00', pct: '-0.42%', up: false, sector: 'Insurance', state: 'Ohio' },
  { sym: 'AEP', name: 'American Electric Power', price: '125.02', pct: '-0.29%', up: false, sector: 'Energy', state: 'Ohio' },
  { sym: 'OC', name: 'Owens Corning', price: '154.02', pct: '-1.17%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'KR', name: 'Kroger', price: '56.94', pct: '-0.51%', up: false, sector: 'Retail', state: 'Ohio' },
  { sym: 'CLF', name: 'Cleveland-Cliffs', price: '12.15', pct: '+0.00%', up: true, sector: 'Industrials', state: 'Ohio' },
  { sym: 'F', name: 'Ford Motor Company', price: '14.20', pct: '+2.23%', up: true, sector: 'Consumer', state: 'Michigan' },
  { sym: 'GM', name: 'General Motors', price: '86.71', pct: '+0.37%', up: true, sector: 'Consumer', state: 'Michigan' },
  { sym: 'DOW', name: 'Dow Inc', price: '31.09', pct: '+2.40%', up: true, sector: 'Industrials', state: 'Michigan' },
  { sym: 'GIS', name: 'General Mills', price: '39.09', pct: '+0.46%', up: true, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'BBY', name: 'Best Buy', price: '86.93', pct: '+1.85%', up: true, sector: 'Retail', state: 'Minnesota' },
  { sym: 'ECL', name: 'Ecolab', price: '275.53', pct: '-0.26%', up: false, sector: 'Industrials', state: 'Minnesota' },
  { sym: 'HRL', name: 'Hormel Foods', price: '24.53', pct: '+0.37%', up: true, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'HOG', name: 'Harley-Davidson', price: '27.98', pct: '+0.47%', up: true, sector: 'Consumer', state: 'Wisconsin' },
  { sym: 'JCI', name: 'Johnson Controls', price: '152.05', pct: '+0.40%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'GNRC', name: 'Generac Holdings', price: '219.79', pct: '+1.44%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'CNC', name: 'Centene Corporation', price: '67.38', pct: '+2.03%', up: true, sector: 'Healthcare', state: 'Missouri' },
  { sym: 'HRB', name: 'H&R Block', price: '52.93', pct: '-0.77%', up: false, sector: 'Professional Services', state: 'Missouri' },
  { sym: 'BG', name: 'Bunge Global', price: '113.97', pct: '+1.10%', up: true, sector: 'Agriculture', state: 'Missouri' },
  { sym: 'PFG', name: 'Principal Financial Group', price: '114.85', pct: '-0.07%', up: false, sector: 'Insurance', state: 'Iowa' },
  { sym: 'CASY', name: 'Casey\'s General Stores', price: '851.68', pct: '-0.25%', up: false, sector: 'Retail', state: 'Iowa' },
  { sym: 'GRMN', name: 'Garmin', price: '312.53', pct: '+0.19%', up: true, sector: 'Technology', state: 'Kansas' },
  { sym: 'BRK-B', name: 'Berkshire Hathaway', price: '505.95', pct: '-0.19%', up: false, sector: 'Insurance', state: 'Nebraska' },
  { sym: 'UNP', name: 'Union Pacific', price: '300.20', pct: '+0.81%', up: true, sector: 'Industrials', state: 'Nebraska' },
  { sym: 'HUM', name: 'Humana', price: '383.53', pct: '-0.37%', up: false, sector: 'Healthcare', state: 'Kentucky' },
  { sym: 'YUM', name: 'Yum! Brands', price: '149.62', pct: '-0.82%', up: false, sector: 'Consumer', state: 'Kentucky' },
  { sym: 'BF-B', name: 'Brown-Forman', price: '28.01', pct: '-0.07%', up: false, sector: 'Consumer', state: 'Kentucky' },
];
