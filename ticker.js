...
const STOCK_TICKERS = [
  { sym: 'LLY',  name: 'Eli Lilly',             price: '1,158.53', pct: '-0.13%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'CMI',  name: 'Cummins',               price: '551.12',   pct: '+0.04%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'ELV',  name: 'Elevance Health',       price: '415.01',   pct: '+2.26%', up: true,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'STLD', name: 'Steel Dynamics',        price: '248.07',   pct: '+0.17%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'SPG',  name: 'Simon Property Group',  price: '211.19',   pct: '+0.47%', up: true,  sector: 'Real Estate', state: 'Indiana'   },
  { sym: 'CTVA', name: 'Corteva',               price: '88.35',    pct: '-1.80%', up: false,  sector: 'Agriculture', state: 'Indiana'   },
  { sym: 'ALSN', name: 'Allison Transmission',  price: '128.80',   pct: '+1.65%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'CAT',  name: 'Caterpillar',           price: '795.46', pct: '+0.40%', up: true,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'DE',   name: 'Deere & Company',       price: '694.08',   pct: '-0.61%', up: false,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'ADM',  name: 'Archer-Daniels-Midland',price: '83.84',    pct: '-1.80%', up: false,  sector: 'Agriculture', state: 'Illinois'  },
  { sym: 'FITB', name: 'Fifth Third Bancorp',   price: '54.97',    pct: '+1.05%', up: true,  sector: 'Banking',     state: 'Ohio'      },
  { sym: 'PG',   name: 'Procter & Gamble',      price: '147.85',   pct: '+0.14%', up: true, sector: 'Consumer',    state: 'Ohio'      },
  { sym: 'WHR',  name: 'Whirlpool',             price: '38.26',    pct: '-1.70%', up: false, sector: 'Consumer',    state: 'Michigan'  },
  { sym: 'SYK',  name: 'Stryker',               price: '309.57',   pct: '-0.84%', up: false, sector: 'Healthcare',  state: 'Michigan'  },
  { sym: 'MMM',  name: '3M',                    price: '167.71',   pct: '-0.62%', up: false,  sector: 'Industrials', state: 'Minnesota' },
  { sym: 'TGT',  name: 'Target',                price: '164.92',   pct: '+0.95%', up: true, sector: 'Retail',      state: 'Minnesota' },
  { sym: 'USB',  name: 'U.S. Bancorp',          price: '63.44',    pct: '+1.07%', up: true,  sector: 'Banking',     state: 'Minnesota' },
  { sym: 'NTRS', name: 'Northern Trust',        price: '186.16',   pct: '+1.18%', up: true,  sector: 'Banking',     state: 'Illinois'  },
  { sym: 'CAH',  name: 'Cardinal Health',       price: '248.51',   pct: '+1.23%', up: true,  sector: 'Healthcare',  state: 'Ohio'      },
  { sym: 'BAX',  name: 'Baxter International',  price: '25.47',    pct: '-0.89%', up: false,  sector: 'Healthcare',  state: 'Illinois'  },
  { sym: 'MDT',  name: 'Medtronic',             price: '92.66',    pct: '+0.52%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'UNH',  name: 'UnitedHealth Group',    price: '404.43',   pct: '+1.19%', up: true,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'PH',   name: 'Parker Hannifin',       price: '959.21',   pct: '+1.04%', up: true, sector: 'Industrials', state: 'Ohio'      },
  { sym: 'ITW',  name: 'Illinois Tool Works',   price: '272.17',   pct: '+1.14%', up: true, sector: 'Industrials', state: 'Illinois'  },
  { sym: 'EMR',  name: 'Emerson Electric',      price: '149.76',   pct: '+0.52%', up: true, sector: 'Industrials', state: 'Missouri'  },
  { sym: 'ROK',  name: 'Rockwell Automation',   price: '429.54',   pct: '+0.98%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'ABT', name: 'Abbott Laboratories', price: '108.76', pct: '-1.55%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'ABBV', name: 'AbbVie', price: '260.83', pct: '-0.34%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'MCD', name: 'McDonald\'s', price: '259.01', pct: '-0.74%', up: false, sector: 'Consumer', state: 'Illinois' },
  { sym: 'EXC', name: 'Exelon', price: '44.52', pct: '+1.25%', up: true, sector: 'Energy', state: 'Illinois' },
  { sym: 'CAG', name: 'Conagra Brands', price: '15.74', pct: '-2.72%', up: false, sector: 'Agriculture', state: 'Illinois' },
  { sym: 'ALL', name: 'Allstate', price: '265.76', pct: '+2.48%', up: true, sector: 'Insurance', state: 'Illinois' },
  { sym: 'CME', name: 'CME Group', price: '282.39', pct: '+1.66%', up: true, sector: 'Banking', state: 'Illinois' },
  { sym: 'GWW', name: 'W.W. Grainger', price: '1,308.62', pct: '+1.85%', up: true, sector: 'Industrials', state: 'Illinois' },
  { sym: 'MPC', name: 'Marathon Petroleum', price: '391.85', pct: '+1.25%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'SHW', name: 'Sherwin-Williams', price: '332.97', pct: '+0.52%', up: true, sector: 'Industrials', state: 'Ohio' },
  { sym: 'GT', name: 'Goodyear Tire & Rubber', price: '6.20', pct: '-0.16%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'PGR', name: 'Progressive Corporation', price: '224.55', pct: '+1.43%', up: true, sector: 'Insurance', state: 'Ohio' },
  { sym: 'AEP', name: 'American Electric Power', price: '124.93', pct: '+1.10%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'OC', name: 'Owens Corning', price: '134.05', pct: '-0.15%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'KR', name: 'Kroger', price: '58.86', pct: '+1.10%', up: true, sector: 'Retail', state: 'Ohio' },
  { sym: 'CLF', name: 'Cleveland-Cliffs', price: '12.42', pct: '+0.00%', up: true, sector: 'Industrials', state: 'Ohio' },
  { sym: 'F', name: 'Ford Motor Company', price: '14.47', pct: '+2.33%', up: true, sector: 'Consumer', state: 'Michigan' },
  { sym: 'GM', name: 'General Motors', price: '86.83', pct: '+2.31%', up: true, sector: 'Consumer', state: 'Michigan' },
  { sym: 'DOW', name: 'Dow Inc', price: '30.69', pct: '-1.89%', up: false, sector: 'Industrials', state: 'Michigan' },
  { sym: 'GIS', name: 'General Mills', price: '38.93', pct: '-4.07%', up: false, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'BBY', name: 'Best Buy', price: '87.54', pct: '+0.62%', up: true, sector: 'Retail', state: 'Minnesota' },
  { sym: 'ECL', name: 'Ecolab', price: '280.01', pct: '+0.04%', up: true, sector: 'Industrials', state: 'Minnesota' },
  { sym: 'HRL', name: 'Hormel Foods', price: '21.85', pct: '-0.91%', up: false, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'HOG', name: 'Harley-Davidson', price: '27.42', pct: '-1.40%', up: false, sector: 'Consumer', state: 'Wisconsin' },
  { sym: 'JCI', name: 'Johnson Controls', price: '141.32', pct: '+1.49%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'GNRC', name: 'Generac Holdings', price: '181.23', pct: '+0.26%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'CNC', name: 'Centene Corporation', price: '68.53', pct: '+1.77%', up: true, sector: 'Healthcare', state: 'Missouri' },
  { sym: 'HRB', name: 'H&R Block', price: '51.27', pct: '+0.61%', up: true, sector: 'Professional Services', state: 'Missouri' },
  { sym: 'BG', name: 'Bunge Global', price: '119.83', pct: '-2.47%', up: false, sector: 'Agriculture', state: 'Missouri' },
  { sym: 'PFG', name: 'Principal Financial Group', price: '118.98', pct: '+6.89%', up: true, sector: 'Insurance', state: 'Iowa' },
  { sym: 'CASY', name: 'Casey\'s General Stores', price: '763.09', pct: '+1.26%', up: true, sector: 'Retail', state: 'Iowa' },
  { sym: 'GRMN', name: 'Garmin', price: '277.66', pct: '+0.59%', up: true, sector: 'Technology', state: 'Kansas' },
  { sym: 'BRK-B', name: 'Berkshire Hathaway', price: '508.42', pct: '+0.63%', up: true, sector: 'Insurance', state: 'Nebraska' },
  { sym: 'UNP', name: 'Union Pacific', price: '291.50', pct: '+0.61%', up: true, sector: 'Industrials', state: 'Nebraska' },
  { sym: 'HUM', name: 'Humana', price: '410.09', pct: '+2.27%', up: true, sector: 'Healthcare', state: 'Kentucky' },
  { sym: 'YUM', name: 'Yum! Brands', price: '152.31', pct: '+0.69%', up: true, sector: 'Consumer', state: 'Kentucky' },
  { sym: 'BF-B', name: 'Brown-Forman', price: '27.42', pct: '+0.15%', up: true, sector: 'Consumer', state: 'Kentucky' },
];
