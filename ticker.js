...
const STOCK_TICKERS = [
  { sym: 'LLY',  name: 'Eli Lilly',             price: '1,176.10', pct: '-1.12%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'CMI',  name: 'Cummins',               price: '573.87',   pct: '-0.74%', up: false,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'ELV',  name: 'Elevance Health',       price: '399.11',   pct: '-0.85%', up: false,  sector: 'Healthcare',  state: 'Indiana'   },
  { sym: 'STLD', name: 'Steel Dynamics',        price: '235.84',   pct: '-0.03%', up: false,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'SPG',  name: 'Simon Property Group',  price: '214.89',   pct: '-1.02%', up: false,  sector: 'Real Estate', state: 'Indiana'   },
  { sym: 'CTVA', name: 'Corteva',               price: '82.40',    pct: '-0.58%', up: false,  sector: 'Agriculture', state: 'Indiana'   },
  { sym: 'ALSN', name: 'Allison Transmission',  price: '129.16',   pct: '+0.30%', up: true,  sector: 'Industrials', state: 'Indiana'   },
  { sym: 'CAT',  name: 'Caterpillar',           price: '817.00', pct: '-0.60%', up: false,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'DE',   name: 'Deere & Company',       price: '622.66',   pct: '-1.87%', up: false,  sector: 'Industrials', state: 'Illinois'  },
  { sym: 'ADM',  name: 'Archer-Daniels-Midland',price: '79.10',    pct: '-1.24%', up: false,  sector: 'Agriculture', state: 'Illinois'  },
  { sym: 'FITB', name: 'Fifth Third Bancorp',   price: '54.85',    pct: '-0.45%', up: false,  sector: 'Banking',     state: 'Ohio'      },
  { sym: 'PG',   name: 'Procter & Gamble',      price: '143.14',   pct: '-1.28%', up: false, sector: 'Consumer',    state: 'Ohio'      },
  { sym: 'WHR',  name: 'Whirlpool',             price: '39.75',    pct: '-0.97%', up: false, sector: 'Consumer',    state: 'Michigan'  },
  { sym: 'SYK',  name: 'Stryker',               price: '322.12',   pct: '-2.29%', up: false, sector: 'Healthcare',  state: 'Michigan'  },
  { sym: 'MMM',  name: '3M',                    price: '178.83',   pct: '-0.65%', up: false,  sector: 'Industrials', state: 'Minnesota' },
  { sym: 'TGT',  name: 'Target',                price: '165.93',   pct: '+1.15%', up: true, sector: 'Retail',      state: 'Minnesota' },
  { sym: 'USB',  name: 'U.S. Bancorp',          price: '62.40',    pct: '-0.64%', up: false,  sector: 'Banking',     state: 'Minnesota' },
  { sym: 'NTRS', name: 'Northern Trust',        price: '186.27',   pct: '-0.74%', up: false,  sector: 'Banking',     state: 'Illinois'  },
  { sym: 'CAH',  name: 'Cardinal Health',       price: '235.13',   pct: '-1.37%', up: false,  sector: 'Healthcare',  state: 'Ohio'      },
  { sym: 'BAX',  name: 'Baxter International',  price: '25.93',    pct: '-2.15%', up: false,  sector: 'Healthcare',  state: 'Illinois'  },
  { sym: 'MDT',  name: 'Medtronic',             price: '89.97',    pct: '-2.23%', up: false,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'UNH',  name: 'UnitedHealth Group',    price: '395.05',   pct: '-1.49%', up: false,  sector: 'Healthcare',  state: 'Minnesota' },
  { sym: 'PH',   name: 'Parker Hannifin',       price: '1,011.20',   pct: '-2.72%', up: false, sector: 'Industrials', state: 'Ohio'      },
  { sym: 'ITW',  name: 'Illinois Tool Works',   price: '281.67',   pct: '-1.34%', up: false, sector: 'Industrials', state: 'Illinois'  },
  { sym: 'EMR',  name: 'Emerson Electric',      price: '157.71',   pct: '-0.37%', up: false, sector: 'Industrials', state: 'Missouri'  },
  { sym: 'ROK',  name: 'Rockwell Automation',   price: '433.00',   pct: '+0.29%', up: true, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'ABT', name: 'Abbott Laboratories', price: '111.59', pct: '-2.20%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'ABBV', name: 'AbbVie', price: '258.15', pct: '-1.81%', up: false, sector: 'Healthcare', state: 'Illinois' },
  { sym: 'MCD', name: 'McDonald\'s', price: '260.06', pct: '-2.57%', up: false, sector: 'Consumer', state: 'Illinois' },
  { sym: 'EXC', name: 'Exelon', price: '43.96', pct: '-1.08%', up: false, sector: 'Energy', state: 'Illinois' },
  { sym: 'CAG', name: 'Conagra Brands', price: '16.02', pct: '-1.05%', up: false, sector: 'Agriculture', state: 'Illinois' },
  { sym: 'ALL', name: 'Allstate', price: '257.62', pct: '-1.60%', up: false, sector: 'Insurance', state: 'Illinois' },
  { sym: 'CME', name: 'CME Group', price: '280.94', pct: '-0.01%', up: false, sector: 'Banking', state: 'Illinois' },
  { sym: 'GWW', name: 'W.W. Grainger', price: '1,321.08', pct: '-1.07%', up: false, sector: 'Industrials', state: 'Illinois' },
  { sym: 'MPC', name: 'Marathon Petroleum', price: '363.54', pct: '+0.35%', up: true, sector: 'Energy', state: 'Ohio' },
  { sym: 'SHW', name: 'Sherwin-Williams', price: '345.21', pct: '-0.99%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'GT', name: 'Goodyear Tire & Rubber', price: '6.15', pct: '-1.76%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'PGR', name: 'Progressive Corporation', price: '217.65', pct: '-2.18%', up: false, sector: 'Insurance', state: 'Ohio' },
  { sym: 'AEP', name: 'American Electric Power', price: '122.71', pct: '-0.53%', up: false, sector: 'Energy', state: 'Ohio' },
  { sym: 'OC', name: 'Owens Corning', price: '143.68', pct: '-1.39%', up: false, sector: 'Industrials', state: 'Ohio' },
  { sym: 'KR', name: 'Kroger', price: '56.93', pct: '-2.70%', up: false, sector: 'Retail', state: 'Ohio' },
  { sym: 'CLF', name: 'Cleveland-Cliffs', price: '11.83', pct: '+2.51%', up: true, sector: 'Industrials', state: 'Ohio' },
  { sym: 'F', name: 'Ford Motor Company', price: '13.95', pct: '+0.36%', up: true, sector: 'Consumer', state: 'Michigan' },
  { sym: 'GM', name: 'General Motors', price: '86.18', pct: '-0.17%', up: false, sector: 'Consumer', state: 'Michigan' },
  { sym: 'DOW', name: 'Dow Inc', price: '30.33', pct: '+0.00%', up: true, sector: 'Industrials', state: 'Michigan' },
  { sym: 'GIS', name: 'General Mills', price: '40.44', pct: '+0.90%', up: true, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'BBY', name: 'Best Buy', price: '83.56', pct: '-4.44%', up: false, sector: 'Retail', state: 'Minnesota' },
  { sym: 'ECL', name: 'Ecolab', price: '285.91', pct: '-1.61%', up: false, sector: 'Industrials', state: 'Minnesota' },
  { sym: 'HRL', name: 'Hormel Foods', price: '21.28', pct: '-10.25%', up: false, sector: 'Agriculture', state: 'Minnesota' },
  { sym: 'HOG', name: 'Harley-Davidson', price: '27.84', pct: '-0.04%', up: false, sector: 'Consumer', state: 'Wisconsin' },
  { sym: 'JCI', name: 'Johnson Controls', price: '142.21', pct: '-1.47%', up: false, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'GNRC', name: 'Generac Holdings', price: '197.29', pct: '-4.52%', up: false, sector: 'Industrials', state: 'Wisconsin' },
  { sym: 'CNC', name: 'Centene Corporation', price: '65.33', pct: '-0.21%', up: false, sector: 'Healthcare', state: 'Missouri' },
  { sym: 'HRB', name: 'H&R Block', price: '52.51', pct: '-0.30%', up: false, sector: 'Professional Services', state: 'Missouri' },
  { sym: 'BG', name: 'Bunge Global', price: '111.57', pct: '-1.48%', up: false, sector: 'Agriculture', state: 'Missouri' },
  { sym: 'PFG', name: 'Principal Financial Group', price: '112.17', pct: '-0.04%', up: false, sector: 'Insurance', state: 'Iowa' },
  { sym: 'CASY', name: 'Casey\'s General Stores', price: '763.38', pct: '-5.42%', up: false, sector: 'Retail', state: 'Iowa' },
  { sym: 'GRMN', name: 'Garmin', price: '289.87', pct: '+0.29%', up: true, sector: 'Technology', state: 'Kansas' },
  { sym: 'BRK-B', name: 'Berkshire Hathaway', price: '503.70', pct: '-0.24%', up: false, sector: 'Insurance', state: 'Nebraska' },
  { sym: 'UNP', name: 'Union Pacific', price: '307.67', pct: '-0.95%', up: false, sector: 'Industrials', state: 'Nebraska' },
  { sym: 'HUM', name: 'Humana', price: '392.63', pct: '+0.40%', up: true, sector: 'Healthcare', state: 'Kentucky' },
  { sym: 'YUM', name: 'Yum! Brands', price: '150.75', pct: '-2.37%', up: false, sector: 'Consumer', state: 'Kentucky' },
  { sym: 'BF-B', name: 'Brown-Forman', price: '27.28', pct: '-2.81%', up: false, sector: 'Consumer', state: 'Kentucky' },
];
